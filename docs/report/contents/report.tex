...
对每个点取其 $k$ 个近邻，计算邻域质心，得到 $3\times3$ 协方差矩阵
\[
...
\subsection{区域生长分割}
区域生长把“表面朝向一致、且空间连通”的点聚成同一片段，步骤如下：
